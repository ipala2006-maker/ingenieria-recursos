(function () {
  ...
  function loadProductStyle() {
    if (!document.querySelector('link[href*="styles/product-ui.css"]')) {
      const link = document.createElement("link");
      link.rel = "stylesheet";
  ...
  function loadBandejaScript() {
    ...
    const script = document.createElement("script");
    script.src = `${rootPath}scripts/bandeja.js?v=20260911-inbox-alarms`;
    script.defer = true;
    document.head.appendChild(script);
  }
  ...
  function loadInboxAlarms() {
    ...
    rules.src = `${rootPath}shared/inbox-alarms.js?v=20260911`;
    rules.onload = () => {
      const ui = document.createElement('script');
      ui.src = `${rootPath}scripts/inbox-alarms.js?v=20260911`;
  ...
  function loadDashboardScript() {
    ...
    const script = document.createElement("script");
    script.src = `${rootPath}scripts/dashboard.js?v=20260911-inbox-alarms`;
    script.defer = true;
    document.head.appendChild(script);
  }

...
En Windows también aparece **Agregar al escritorio**. Ese botón descarga `Estudiemos-Widgets.rmskin`, un único instalador que activa y ordena los cuatro widgets fijos de Rainmeter. Cada widget queda aislado de la app y se puede redimensionar arrastrando su esquina inferior derecha. Rainmeter y el complemento WebView2 deben estar instalados en el equipo; Windows siempre solicita la confirmación final por seguridad.
